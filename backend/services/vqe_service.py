...
# Constants
VQE_SCRIPT = os.path.abspath("/home/texsols/QuantBio/algorithms/protein-folding/solution.py")
OUTPUT_FOLDER = os.path.abspath("/home/texsols/QuantBio/outputs/vqe_output")
CONDA_ENV_NAME = "proteinfoldingvqe"
...
def generate_azure_link(task_id, file_name):
    base_url = "https://biotex.blob.core.windows.net/proteinfold/outputs/vqe_output"
...
def run_vqe(params):
    ...
    cd /home/texsols/QuantBio/algorithms/protein-folding &&
    python3 solution.py --sequence "{sequence}" --out_dir "{task_output_folder}" > "{output_log}" 2>&1
    """

    logging.info(f"Executing VQE command:\n{command}")
    ...
    return {
        "message": "VQE processing completed",
        "task_id": task_id,
